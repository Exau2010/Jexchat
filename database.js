...
// Suppression complète et définitive d'un groupe (distincte de "quitter le
// groupe" qui ne retire qu'un membre). Nettoie les messages du groupe et les
// notifications qui y font référence, sans toucher aux publications (Post)
// qui vivent indépendamment des conversations.
async function deleteGroupConversation(convId) {
  ...
  await Conversation.deleteOne({ _id: cid, type: 'group' });
}
