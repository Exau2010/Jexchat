...
// Suppression définitive : toujours filtrée sur l'utilisateur authentifié
// (jamais un userId fourni par le client), pour qu'un utilisateur ne puisse
// jamais supprimer les notifications d'un autre compte.
