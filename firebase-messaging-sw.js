  ...
  try {
    ...
    messaging.onBackgroundMessage((payload) => {
      ...
      const notificationOptions = {
        ...
        // /icon-192.png et /badge-72.png n'existent pas dans le projet et ne
        // sont servis par aucune route : une référence cassée ici empêchait
        // silencieusement l'affichage de la notification dans certains
        // navigateurs. /logo.png est le seul visuel réellement présent et
        // servi (voir server.js), donc réutilisé ici pour les deux.
        icon: '/logo.png',
        badge: '/logo.png',
