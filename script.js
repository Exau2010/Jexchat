...
async function toggleNotifPanel() {
  ...
  if (!panel) {
    ...
    panel.innerHTML = `
      <div class="notif-panel-header">
        ...
        <div class="flex items-center" style="gap:4px">
          ...
          <button class="btn btn-ghost btn-sm" id="notif-delete-all" title="Supprimer les notifications">Supprimer</button>
        </div>
      </div>
    ...
    // Suppression définitive (MongoDB) de toutes les notifications de
    // l'utilisateur connecté ; la liste n'est vidée côté interface qu'après
